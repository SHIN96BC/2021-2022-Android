...
//        Log.i("ThirdHandler", "b2 clicked");
    ...
    void m3(){
        ...
        if (ActivityCompat.checkSelfPermission(m, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            m.requestPermissions(new String[]{Manifest.permission.CALL_PHONE}, 1000);
    ...
    private void m4(){
        ...
        if (ActivityCompat.checkSelfPermission(m, Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED) {
            m.requestPermissions(new String[]{Manifest.permission.SEND_SMS}, 1000);
    ...
    void m7() {
//        Log.i("ThirdHandler", "b7 clicked");
        Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:khs1128@gmail.com"));
        m.startActivity(intent);
    }
    ...
    private void m10(){ //참조자 추가
        ...
        m.startActivity(Intent.createChooser(it, "Choose Email Client"));
    }
    private void m11(){ //공유
